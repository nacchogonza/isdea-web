...
export default function MenuWithSubitemsMobile({ item }: ItemWithSub) {
  ...
  return (
    <div
      className="relative text-left block lg:hidden"
    ...
    >
      <div>
        <button
          ...
          id={item.item_title}
          className="block focus:outline-none focus:ring focus:border-cm-primary xl:hidden px-2 py-2 font-medium text-gray-500 hover:text-gray-800 transition duration-300 ease-in-out my-2"
        >
      ...
      <div
        className={
          menuToggle
            ? 'mt-1 mb-2 rounded-lg w-full shadow-lg bg-white transition ease-out duration-300 ring-1 ring-cm-primary ring-opacity-5 transform opacity-100 scale-100 block'
            : 'mt-1 rounded-lg w-full shadow-lg bg-white transition ease-out duration-300 ring-1 ring-cm-primary ring-opacity-5 transform opacity-0 scale-0 hidden'
        }
      >
